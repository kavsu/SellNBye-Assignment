							...
							<div class="panel-body">
								<form action="${contextRoot}/payment" method="POST"
									...
									<div class="form-group">
										<label for="cardNo" class="col-md-4 control-label">Card No:
										</label>
										<div class="col-md-8">
									...
									<div class="form-group">
										<label for="cardPwd" class="col-md-4 control-label">Card Password:
										</label>
										<div class="col-md-8">
									...
									<div class="form-group">
										<label for="expDate" class="col-md-4 control-label">Card Password:
										</label>
										<div class="col-md-8">
