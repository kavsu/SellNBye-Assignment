...
VALUES ('Rasi', 'Perera', 'ADMIN', true, 'Dlw6BQhYKSs7dVfn7RFPTjzxOpzyXJUE3IqmTGjSfmw=', 'rasi123@gmail.com', '0777272727');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
...
CREATE TABLE payment(
	...
	CONSTRAINT fk_cust_id FOREIGN KEY (cust_id) REFERENCES user_detail (id)
);

INSERT INTO payment (id, user_id, cardNo, expiryDate, cardPwd, amount, paymentDate)
